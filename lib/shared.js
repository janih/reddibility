...
var GR = (function () {
  ...
  var THEMES = {
    light: { name: "Light", bg: "#ffffff", text: "#1f2328", link: "#0969da" },
    sepia: { name: "Sepia", bg: "#f4ecd8", text: "#5b4636", link: "#9a5b2d" },
    dark: { name: "Dark", bg: "#1b1b1f", text: "#d6d6d6", link: "#7ab4ff" },
    highcontrast: { name: "High Contrast", bg: "#000000", text: "#ffffff", link: "#ffd400" },
    solarizedlight: { name: "Solarized Light", bg: "#fdf6e3", text: "#586e75", link: "#268bd2" },
    solarizeddark: { name: "Solarized Dark", bg: "#002b36", text: "#93a1a1", link: "#268bd2" },
    nord: { name: "Nord", bg: "#2e3440", text: "#d8dee9", link: "#88c0d0" },
  };
